...
$footer_bg = get_template_directory_uri() . '/assets/img/footer_bg1.webp';
...
<footer class="site-footer" style="background: linear-gradient(rgba(17, 17, 17, 0.85), rgba(17, 17, 17, 0.9)), url('<?php echo esc_url($footer_bg); ?>') no-repeat center center / cover; position: relative; overflow: hidden;">
    <!-- Градиентный оверлей поверх фона -->
    <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: linear-gradient(135deg, rgba(44, 120, 32, 0.15) 0%, rgba(139, 197, 61, 0.1) 25%, rgba(255, 255, 1, 0.05) 50%, transparent 100%); z-index: 0;"></div>
                            ...
                            <?php if ($max_link): ?>
                                <a href="<?php echo esc_url($max_link); ?>" class="footer-social__link max-link" target="_blank" rel="noopener" title="Max">
                                    <svg width="24" height="24" viewBox="0 0 42 42" fill="currentColor">
                                        <path fill-rule="evenodd" d="M21.47 41.88c-4.11 0-6.02-.6-9.34-3-2.1 2.7-8.75 4.81-9.04 1.2 0-2.71-.6-5-1.28-7.5C1 29.5.08 26.07.08 21.1.08 9.23 9.82.3 21.36.3c11.55 0 20.6 9.37 20.6 20.91a20.6 20.6 0 0 1-20.49 20.67Zm.17-31.32c-5.62-.29-10 3.6-10.97 9.7-.8 5.05.62 11.2 1.83 11.52.58.14 2.04-1.04 2.95-1.95a10.4 10.4 0 0 0 5.08 1.81 a10.7 10.7 0 0 0 11.19-9.97 10.7 10.7 0 0 0-10.08-11.1Z" clip-rule="evenodd"></path>
                                    </svg>
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="footer-column footer-column--contacts">
                        ...
                        <div class="footer-contacts">
                            ...
                            <div class="footer-contact-item">
                                ...
                                <div class="footer-contact-text">г. Краснодар, ул. Героев-Разведчиков 8, корп.1</div>
                            </div>
                            ...
                            <div class="footer-contact-item">
                                ...
                                <div class="footer-contact-text">г. Москва, улица Автозаводская, д. 1</div>
                            </div>
